...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{./Figures/hdfs1}
    \caption{The architecture of HDFS.}
    \label{fig:hdfs}
  \end{figure}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {\frametitle{Network Topology and HDFS}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

  \begin{columns}[c]
    \column{6cm}
    \framebox{\includegraphics[width=6cm]{./Figures/topology}}
    \column{3cm}
    \framebox{\includegraphics[width=3cm]{./Figures/placement}}
  \end{columns}
