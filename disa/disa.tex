...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {\frametitle{What is the ``Map Reduce'' Programming Model?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{itemize}
  \item \textbf{A distributed programming model}:
    \begin{itemize}
    \item Inspired by functional programming
    \item Inspired by Bulk Synchronous Parallelism (BSP)
    \end{itemize}

\vspace{20pt}

  \item \textbf{An instance of an execution framework}:
    \begin{itemize}
