...
\frame {\frametitle{Two-phase commit}
	...
	\begin{itemize}
		\item Phase 1
		\begin{itemize}
			\item One coordinator node \emph{C} suggests a value to the other nodes (1)
			\item C gathers the responses (2)
		\end{itemize}
		\item Phase 2
		\begin{itemize}
			\item If all nodes agree, C sends a commit command, abort otherwise (3)
		\end{itemize}
	\end{itemize}
