...
\frame {\frametitle{A Paxos round - 1}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/paxos-round1}
	\end{center}
...
\frame {\frametitle{A Paxos round - 2}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/paxos-round2}
	\end{center}
...
\frame {\frametitle{Raft - learning tools}
	\begin{enumerate}
		...
		\item Secret lived of Data: \url{http://thesecretlivesofdata.com/raft/}
	\end{enumerate}
}
