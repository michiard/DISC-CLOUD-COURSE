...
\begin{itemize}
  ...
  \item[] \texttt{Y = GROUP A BY f1;}
  \item[] \texttt{Z = FOREACH X GENERATE group, X.(\$1, \$2);} 
\end{itemize}
...
\end{itemize}
  ...
  \begin{columns}
    ...
    \begin{itemize}
      \item[] \texttt{X=}
      \item[] \texttt{<1, {<1, 2, 3>}>}
      \item[] \texttt{<4, {<4, 2, 1>, <4, 3, 3>}> <7, {<7, 2, 5>}>}
...
\begin{itemize}
  ...
  \item[] \texttt{<4, \{<4, 2, 1>, <4, 3, 3>\}, \{<4, 6>,<4, 9>\}> <7, \{<7, 2, 5>\}, \{ \}>} 
