...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Task can be executed locally and we don't have to shuffle. (E.g. \texttt{map}, \texttt{flatMap}, \texttt{filter}, \texttt{sample})
	\end{itemize}
	...
	\begin{itemize}
		...
		\item This means we have to shuffle data \textbf{unless the parents are hash-partitioned} (E.g. \texttt{sortByKey}, \texttt{reduceByKey}, \texttt{groupByKey}, \texttt{cogroupByKey}, \texttt{join}, \texttt{cartesian})
	\end{itemize}
\end{itemize}
}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Examples:
		\begin{itemize}
			\item \textbf{Pipelining} narrow dependencies within a Stage
...
\begin{itemize}
	...
	\begin{itemize}
		\item Set of operations on an RDD that define how they should be transformed
		...
		\item Transformations are lazily evaluated, which allows optimizations to take place before execution
	\end{itemize}
